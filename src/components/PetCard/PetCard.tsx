...
export function PetCard({ children, className }: PetCardProps) {
  return (
    <Card
      className={`group bg-card border-primary/30 hover:border-primary/50 relative overflow-hidden rounded-3xl border-2 transition-all duration-300 select-none hover:shadow-md ${className || ""}`}
    >
