...
export function ProfileCardEditBtn({
  ...
  return (
    <Button
      ...
      variant="default"
      onClick={handleClick}
      className={`text-background absolute top-3 right-3 h-8 w-8 cursor-pointer rounded-full bg-zinc-500/50 transition-all group-hover:bg-zinc-500/75 hover:scale-105 hover:bg-zinc-500 ${className || ""}`}
    >
