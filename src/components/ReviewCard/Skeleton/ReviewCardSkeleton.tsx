...
import ReviewCardGatheringInfoSkeleton from "./ReviewCardGatheringInfoSkeleton";
import ReviewCardGatheringTitleSkeleton from "./ReviewCardGatheringTitleSkeleton";
...
ReviewCardSkeleton.GatheringTitle = ReviewCardGatheringTitleSkeleton;
ReviewCardSkeleton.GatheringInfo = ReviewCardGatheringInfoSkeleton;
